          ...
          @forelse ($subadmins as $subadmin)
            <tr>
              ...
              <td>
                ...
                <a href="{{route('subadmin.delete',['id'=>$subadmin->id])}}" class="badge badge-primary" onclick="return confirm('Are you sure you want to delete this?');"><i class="mdi mdi-delete"></i></a>
                @endcan
